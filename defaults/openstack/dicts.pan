...
variable OPENSTACK_MAGNUM_DB ?= dict();
variable OPENSTACK_MAGNUM_DB = merge(SELF, dict(
    'dbhost', OPENSTACK_MAGNUM_DB_HOST,
    'dbname', 'magnum',
    'dbuser', OPENSTACK_MAGNUM_DB_USERNAME,
    'dbpassword', OPENSTACK_MAGNUM_DB_PASSWORD,
    'dbprotocol', 'mysql+pymysql',
    'dbport', 3306,
));
